...
namespace StrengthJournal.Core.Integrations.Implementation
{
    public class Auth0AuthenticationService : IAuthenticationService
    {
        ...
        public Auth0AuthenticationService(StrengthJournalContext context, ILogger<Auth0AuthenticationService> logger)
        {
        ...
        public CreateAccountResponse CreateAccount(string username, string password, bool consentCEM, string countryCode)
        {
            ...
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    throw new NotImplementedException("Creation of new user no longer implemented anywhere");
