...
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'AX', N'├àland Islands')
GO
...
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'BL', N'Saint Barth├⌐lemy')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'BM', N'Bermuda')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'BN', N'Brunei Darussalam')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'BO', N'Bolivia, Plurinational State of')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'BQ', N'Bonaire, Sint Eustatius and Saba')
GO
...
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'CC', N'Cocos (Keeling) Islands')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'CD', N'Congo, the Democratic Republic of the')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'CF', N'Central African Republic')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'CG', N'Congo')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'CH', N'Switzerland')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'CI', N'C├┤te d''Ivoire')
GO
...
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'CW', N'Cura├ºao')
GO
...
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'FK', N'Falkland Islands (Malvinas)')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'FM', N'Micronesia, Federated States of')
GO
...
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'IR', N'Iran, Islamic Republic of')
GO
...
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'KP', N'Korea, Democratic People''s Republic of')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'KR', N'Korea, Republic of')
GO
...
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'LA', N'Lao People''s Democratic Republic')
GO
...
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'MD', N'Moldova, Republic of')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'ME', N'Montenegro')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'MF', N'Saint Martin (French part)')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'MG', N'Madagascar')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'MH', N'Marshall Islands')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'MK', N'Macedonia, the Former Yugoslav Republic of')
GO
...
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'PS', N'Palestine, State of')
GO
...
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'RE', N'R├⌐union')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'RO', N'Romania')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'RS', N'Serbia')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'RU', N'Russian Federation')
GO
...
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'SH', N'Saint Helena, Ascension and Tristan da Cunha')
GO
...
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'SX', N'Sint Maarten (Dutch part)')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'SY', N'Syrian Arab Republic')
GO
...
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'TL', N'Timor-Leste')
GO
...
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'TW', N'Taiwan, Province of China')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'TZ', N'Tanzania, United Republic of')
GO
...
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'VA', N'Holy See (Vatican City State)')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'VC', N'Saint Vincent and the Grenadines')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'VE', N'Venezuela, Bolivarian Republic of')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'VG', N'Virgin Islands, British')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'VI', N'Virgin Islands, U.S.')
GO
INSERT [dbo].[Countries] ([Code], [Name]) VALUES (N'VN', N'Viet Nam')
GO
